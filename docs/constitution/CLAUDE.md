...
| **M4.8b** | **Proxy-bound egress** — route schema-tool calls through a central forward proxy (egress allowlist + credential injection) below the app-layer SSRF guard; isolated + tested (deferred from M4.8a per review) | next |
